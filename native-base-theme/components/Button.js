...
export default (variables = variable) => {
  ...
  const buttonTheme = {
      ...
      '.rounded': {
        paddingHorizontal: variables.buttonPadding + (45 -24 -2*variables.buttonPadding)/2,//Add a padding to match the button height => (Button height - icon size -paddingTop -paddingBottom)/2
